...
export class ChaptersService {
     ...
     * @param npcId ID del NPC dueño de la historia
     * @param published Filtrar por estado publicado
     * @returns any Estructura de capítulos obtenida
     * @throws ApiError
     */
    public getChaptersNpc(
        npcId: string,
        published?: boolean,
    ): Observable<{
        ok?: boolean;
     ...
     * @param id ID único del capítulo
